## Basic Routing in ReactJS

This project explains basic Routes implementation in React and these examples are formed from snippets 
and APIs available in React official page.
